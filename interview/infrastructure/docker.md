...
### DOCKER-005
Docker가 사용하는 Linux 커널 기술인 namespace와 cgroups를 설명해 주세요.
...
### DOCKER-020
HEALTHCHECK 명령어의 역할과 설정 옵션을 설명해 주세요.
...
### DOCKER-023
Docker 이미지를 빌드하는 과정과 주요 옵션을 설명해 주세요.

### DOCKER-024
Docker 이미지 태깅 전략과 버전 관리 방법을 설명해 주세요.

### DOCKER-025
Docker 이미지를 프라이빗 레지스트리에 푸시하고 풀하는 과정을 설명해 주세요.

### DOCKER-026
dangling 이미지란 무엇이며, 정리하는 방법을 설명해 주세요.

### DOCKER-027
Docker 이미지의 히스토리를 확인하고 각 레이어의 크기를 분석하는 방법을 설명해 주세요.

### DOCKER-028
base 이미지를 선택할 때 고려해야 할 요소를 설명해 주세요. (alpine, slim, scratch 등)
...
### DOCKER-055
Docker 컨테이너의 보안 위험 요소와 완화 방법을 설명해 주세요.
...
### DOCKER-059
Docker 이미지 취약점 스캐닝의 중요성과 사용 가능한 도구를 설명해 주세요.
...
### DOCKER-063
Docker 컨테이너의 CPU 사용량을 제한하는 방법과 옵션을 설명해 주세요.
...
### DOCKER-087
Docker 레이어 최적화로 이미지 풀/푸시 시간을 단축하는 방법을 설명해 주세요.
...
### DOCKER-101
호스트 CPU에 여유가 있어도 컨테이너에서 CPU throttling이 발생할 수 있나요? 확인 방법을 설명해 주세요.

### DOCKER-102
컨테이너의 종료 코드가 137이면 항상 OOM인가요? 실제 종료 원인을 확인하는 방법을 설명해 주세요.

### DOCKER-103
컨테이너 로그로 디스크가 가득 차는 문제를 어떻게 예방하나요?

### DOCKER-104
컨테이너에 Docker 소켓을 마운트하면 어떤 보안 위험이 있나요?
