...
Garbage Collection의 동작 원리와 종류를 설명해 주세요.
...
static 키워드의 의미와 사용할 때 주의할 점은 무엇인가요?
...
Java 8 이후 인터페이스의 default 메서드와 static 메서드를 설명해 주세요.
...
equals()와 hashCode()의 관계와 오버라이딩할 때 주의할 점은 무엇인가요?
...
Java의 Generic을 설명하고, Type Erasure란 무엇인지 말해 주세요.

### JAVA-015

Comparable과 Comparator의 차이점을 설명해 주세요.
...
Java Memory Model을 설명해 주세요.

### JAVA-023

ThreadLocal의 동작 원리와 주의할 점은 무엇인가요?

### JAVA-024

Executor Framework와 Thread Pool을 설명해 주세요.
...
Functional Interface와 Lambda Expression을 설명해 주세요.
...
Java의 직렬화(Serialization)와 역직렬화를 설명해 주세요.
...
Java의 모듈 시스템(Java 9+)을 설명해 주세요.

### JAVA-037

var 키워드(Java 10+)의 사용법과 제한 사항은 무엇인가요?
...
Pattern Matching(Java 14+)의 개선 사항을 설명해 주세요.
...
Virtual Thread가 도입되면서 동시성 프로그래밍은 어떻게 달라지나요?
...
Switch Expression과 기존 Switch Statement의 차이점을 설명해 주세요.
