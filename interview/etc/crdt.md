...
### CRDT-031
State-based CRDT(CvRDT)와 Operation-based CRDT(CmRDT)의 차이점에 대해 설명해주세요.
...
### CRDT-032
G-Counter, PN-Counter, LWW-Register 등 기본 CRDT 타입에 대해 설명해주세요.
...
### CRDT-034
Local-first Software 아키텍처와 CRDT의 역할에 대해 설명해주세요.
