...
### CRDT-007
Yjs에서 문서의 버전 관리와 업데이트 충돌 해결 방법을 설명해 주세요.
...
### CRDT-011
Yjs로 실시간 협업 애플리케이션을 구현할 때 고려해야 할 사항은 무엇인가요?
...
### CRDT-013
Yjs의 Delta 업데이트 방식과 그 장점을 설명해 주세요.

## Yjs 충돌 해결

### CRDT-014
Yjs 문서 병합 과정에서 발생할 수 있는 충돌 상황은 어떤 것이며, 어떻게 해결하나요?
...
### CRDT-018
Yjs와 WebSocket, WebRTC 등 다른 실시간 통신 프로토콜의 연동 방안을 설명해 주세요.
...
### CRDT-021
Yjs의 모듈화 구조와 플러그인 확장 기능을 설명해 주세요.

## Yjs 네트워크 트래픽

### CRDT-022
Yjs에서 데이터를 업데이트할 때 네트워크 트래픽을 최적화하는 기법은 무엇인가요?

### CRDT-023
Yjs 업데이트 메시지의 크기를 최소화하는 방법을 설명해 주세요.
...
### CRDT-031
State-based CRDT(CvRDT)와 Operation-based CRDT(CmRDT)의 차이점을 설명해 주세요.

## 기본 CRDT 타입

### CRDT-032
G-Counter, PN-Counter, LWW-Register 등 기본 CRDT 타입을 설명해 주세요.

## Tombstone 문제

### CRDT-033
CRDT의 Tombstone 문제란 무엇이며 어떻게 해결하나요?

## Local-first Software

### CRDT-034
Local-first Software 아키텍처와 그 안에서 CRDT가 맡는 역할을 설명해 주세요.
