...
### DS-003
Prefix, Infix, Postfix 표기법을 설명하고, 스택을 활용해 수식을 계산하는 방법을 설명해 주세요.
...
### DS-016
이진탐색트리에서 값을 삽입하고 삭제하는 방법을 설명해 주세요. 어떤 순서로 값을 삽입하면 트리가 한쪽으로 편향될까요?
...
### DS-048
언어에 따라 재귀 함수를 최적화하기도 합니다. 어떤 조건에서 최적화가 가능하고, 실행 방식은 어떻게 달라지는지 설명해 주세요.
