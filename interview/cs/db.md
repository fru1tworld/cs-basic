...
NoSQL을 선택해야 하는 상황과 RDB 대신 NoSQL을 선택하는 이유에 대해 설명해 주세요.
...
### DB-071
CAP 정리(CAP Theorem)에 대해 설명하고, 분산 데이터베이스 선택 시 어떻게 활용되는지 설명해 주세요.
...
### DB-075
슬로우 쿼리(Slow Query)를 발견했을 때, 튜닝하는 방법에 대해 설명해 주세요.
